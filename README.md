...
# Business Challenge: Berlin Crimes EDA
...
Choose a dataset from common datasets repos (Kaggle, UCI Marchine Learning Repository...) and break your work into big steps:
 1. Pick a topic and choose a dataset on that topic. Build around 10 Business questions to answer about this topic (try to build the questions before knowing everything about the data).
